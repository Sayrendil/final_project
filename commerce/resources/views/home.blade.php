    ...
    @section('content')
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(http://www.loceancosmetics.kz/content/banners/powderlog.jpg);">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(http://www.loceancosmetics.kz/content/banners/IMG_karandashi.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(http://www.loceancosmetics.kz/content/banners/BBtest.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <div class="row h-100 align-items-end justify-content-end">
                    <div class="col-12 col-md-8 col-lg-6">
                        <div class="offer-content-area wow fadeInUp" data-wow-delay="1s">
                            <h2>О нас</h2>
                            <p>* Посмотрите видео о нашей компании</p>
                            <a href="#" class="btn karl-btn mt-20"><i class="fa fa-play fa-2x"></i></a>
                        </div>
                    </div>
                </div>
            </div>
